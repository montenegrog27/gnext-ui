...
const ModalGlass = ({ title, content, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed z-10 inset-0 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 py-6 text-center">
        ...
        <div className="relative inline-block bg-white/30 backdrop-blur-lg rounded-lg px-6 py-8 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full">
