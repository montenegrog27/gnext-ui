...
// src/components/ModalGlassmorphism.js

var ModalGlass = function ModalGlass(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    className: "relative inline-block bg-white/30 backdrop-blur-lg rounded-lg px-6 py-8 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full"
...
var _default = exports["default"] = ModalGlass;